...
import { BadgeCheck, FileSearch, Gauge, Network, Ruler, ShieldQuestion, Waypoints } from "lucide-react";
import {
...
function statusClass(status: InstrumentStatus) {
  ...
  if (status === "MEASURED") return "border-emerald-500/35 bg-emerald-500/10 text-emerald-200";
  return "border-slate-700 bg-slate-900/70 text-slate-400";
}

function StatusChip({ status }: { status: InstrumentStatus }) {
