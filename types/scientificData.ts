 ...
 *
 * These types are data contracts only. They do not assert physical truth.
 * Unknown values must remain null/UNKNOWN until evidence exists.
 */
...
export interface ExperimentResult {
  ...
  targetCompoundConcentration?: Record<string, number>;
...
export type GapReason =
  ...
  | 'MISSING_INSTRUMENT_MEASUREMENT';
